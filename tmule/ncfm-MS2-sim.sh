...
RVIZ="true"
RVIZ_CONFIG=`rospack find iliad_launch_system`/config/demos/ncfm-MS2-sim.rviz
SCENARIO_NAME_YAML_FILE=`rospack find iliad_launch_system`/config/demos/ncfm-MS2-sim.yaml
