...
LASER2D_FLOOR="true"
LASER2D_TOP="true"
PALLET_SENSOR_TYPE="orbec"
if [[ $SIM == 'true' ]]; then ROBOT_NAME_YAML_FILE=`rospack find iliad_launch_system`/config/robots/robot5_sim.yaml; else ROBOT_NAME_YAML_FILE=`rospack find iliad_launch_system`/config/robots/robot5.yaml; fi
ROS_MASTER_ROBOT_PORT="11311"
HUMAN_PERCEPTION="true"
